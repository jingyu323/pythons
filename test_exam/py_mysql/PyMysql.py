...
if __name__ == "__main__":
    ...
    pymysql.newConnection("localhost", "root", "root", "line4_240201")
    affected_rows, result = pymysql.query("""SELECT * FROM htgw_sync_main
             WHERE sync_id < 5""")

    print(affected_rows,result)

    row =pymysql.fetch_queryresult(result,8)
    print(row)