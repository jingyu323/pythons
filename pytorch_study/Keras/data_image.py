...
# 载入图片
img = load_img('E:/data/kreas/train/train/cat.1.jpg')
x = img_to_array(img) 
print(x.shape)
...
# 生成21张图片
# flow 随机生成图片
for batch in datagen.flow(x, batch_size=1, save_to_dir='E:/data/kreas/train/tmp', save_prefix='cat', save_format='jpeg'):
    # 执行21次
    i += 1
    if i > 20:
        break 
